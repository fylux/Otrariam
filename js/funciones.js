...
$("#a_cuartel5").click(function(){
$("#cuartel1").css("display", "none");
$("#cuartel2").css("display", "none");
$("#cuartel3").css("display", "none");
$("#cuartel4").css("display", "none");
$("#cuartel5").css("display", "block");
});

$("#a_reportes1").click(function(){
$("#reportes2").css("display", "none");
$("#reportes1").css("display", "block");
});

$("#a_reportes2").click(function(){
$("#reportes2").css("display", "block");
$("#reportes1").css("display", "none");
});
